...
- `task(value)` constructor to lift a pure value into a Task
- `fromPromise(thunk)` constructor to wrap a lazy Promise-returning thunk into a Task
- `all`, `traverse`, and `sequence` helpers for combining multiple Tasks
